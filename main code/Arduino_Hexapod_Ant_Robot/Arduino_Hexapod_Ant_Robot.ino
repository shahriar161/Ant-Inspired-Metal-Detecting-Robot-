...
#define trigPin 7//transmit
#define echoPin 6//receiver
#define ledB 10
...
void prepareAttack() {
  ...
  if (i1H1 <= 15) {
    ...
    s17.write(90 - i1H1);
    // Leg 3
    s24.write(35+50 + i1H1 / 2);
    s23.write(20+80 + i1H1);
    // Leg 4
    s10.write(65 + i1H1);
    s11.write(-35+35 + i1H1);
    // Leg 6
    s1.write(90 - i1H1);
    s2.write(45 - i1H1);
    // Head
...
void dismissAttack() {
  ...
  if (i2H1 <= 15) {
    ...
    s17.write(75 + i2H1);
    // Leg 3
    s24.write(35+57 - i2H1 / 2);
    s23.write(20+95 - i2H1);
    // Leg 4
    s10.write(80 - i2H1);
    s11.write(-35+50 - i2H1);
    // Leg 6
    s1.write(75 + i2H1);
    s2.write(30 + i2H1);
    // Head
...
void attack() {
  ...
  if (i3H1 <= 10) {
    ...
    s17.write(75 + i3H1 * 3);
    // Leg 3
    s24.write(35+57 - i3H1 / 2);
    s23.write(20+95 - i3H1 * 3);
    // Leg 4
    s10.write(80 - i3H1 * 2);
    s11.write(-35+50 - i3H1 * 3);
    // Leg 6
    s1.write(75 + i3H1 * 2);
    s2.write(30 + i3H1 * 3);
    // Head
  ...
  if (i3H1 >= 16 & i4H1 < 15) {
    ...
    s17.write(105 - i4H1);
    // Leg 3
    //s24.write(35+50 + i4H1 / 2);
    s23.write(20+65 + i4H1);
    // Leg 4
    s10.write(60 + i4H1 / 3);
    s11.write(-35+20 + i4H1);
    // Leg 6
    s1.write(95 - i4H1 / 5);
    s2.write(60 - i4H1);
    // Head
...
void moveLeg3() {
  if (i1L1 <= 10) {
    s24.write(35+50 - i1L1 * 2);
    s23.write(20+80 - i1L1 * 3);
  }
  if (i2L1 <= 30) {
    s22.write(80 - i2L1);
  ...
  if (i2L1 > 20 & i3L1 <= 10) {
    s24.write(35+30 + i3L1 * 2);
    s23.write(20+50 + i3L1 * 3);
  }
  if (i2L1 >= 30) {
    s22.write(50 + i4L1);
  }
